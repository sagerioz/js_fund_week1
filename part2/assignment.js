...
arr.sort(function(a,b){
  ...
  var med = (arr[lowMiddle] + arr[highMiddle]) / 2;
  return med || null;
};
...
function distance(point1, point2){
    ...
    var j = Math.pow(point2.x - point1.x, 2)
    var k = Math.pow(point2.y-point1.y, 2)
    return answer= Math.sqrt(j+k);
}
